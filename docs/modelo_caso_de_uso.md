# Descrição do Projeto – Aplicativo de Desenvolvimento de Hábitos e Bem-Estar Pessoal
Este projeto consiste em um aplicativo mobile focado no desenvolvimento de hábitos saudáveis, autoconhecimento e melhoria da qualidade de vida do usuário. O sistema permite que os usuários criem perfis personalizados, definam metas de hábitos, recebam lembretes, registrem reflexões diárias, acompanhem estatísticas de progresso e compartilhem suas conquistas.

O aplicativo também oferece funcionalidades voltadas ao bem-estar integral, como cronograma de sono, controle de vícios com feedbacks de economia gerada, e mensagens motivacionais para manter o engajamento. O uso de notificações inteligentes e visualizações gráficas ajuda os usuários a manterem consistência e motivação ao longo do tempo.

As principais funcionalidades incluem:

- Cadastro e login de usuários com perfil personalizado

- Criação, edição e acompanhamento de metas de hábitos

- Envio de notificações com base em lembretes configurados pelo usuário

- Visualização de progresso por gráficos ou listas estatísticas

- Mensagens motivacionais e dicas periódicas geradas pelo sistema

- Compartilhamento de conquistas

- Controle de horário de sono com lembretes noturnos

- Registro e acompanhamento de vícios e economia gerada com o abandono

- Espaço para reflexões diárias com escolha de sentimento associado

O projeto tem como objetivo ser um companheiro digital de apoio à rotina, promovendo autodisciplina, saúde mental e emocional e incentivando práticas que levam à melhoria contínua da vida pessoal do usuário.
